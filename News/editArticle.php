...
<html lang = "en">
	<head>
		...
		<title>Elite News - Edit Article</title>
	...
	<body>
		...
		<nav>
            ...
            <form method = "POST" action="" enctype="multipart/form-data">
				...
				<!-- all the input fields and textarea fields are prefilled with the article data which is clicked for editing... -->
				<!-- Title input field -->
                <label>Title</label> <input type="text" name =  "title" value = "<?php echo $results[1]; ?>" required/>
				<?php 
				...
				<label>Content</label> <textarea name="content" rows="15" required><?php echo $results[2];?></textarea>
				<?php 
				...
				?>
				<!-- image upload field -->
                <label>Image (Optional)</label> <input type="file" name="uploadfile" multiple accept="image/*"> 
