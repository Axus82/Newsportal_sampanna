...
<html lang = "en">
	<head>
		...
		<title>Elite News - Add Category</title>
	</head>
	<body>
		<header>
		<div class = "userinfo">
		...
		<main>
			...
			<section class = "news_list_container">
                <h2 id = "heading"><?php
				// if the category is added successfully, then it prompts the message...
						if($posted == true){
            ...
            <form method = "POST" action="">
                ...
                <label>Category Name</label> <input type="text" name="category" style = "width: 30%;" required/>
                <?php
